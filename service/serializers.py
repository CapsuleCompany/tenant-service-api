...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for option_data in options_data:
            ...
            service_option = ServiceOption.objects.create(service=service, **option_data)
            for value_data in values_data:
                ServiceOptionValue.objects.create(option=service_option, **value_data)
        return service
    ...
    def update(self, instance, validated_data):
        ...
        instance.predicted_category = validated_data.get("predicted_category", instance.predicted_category)
        instance.description = validated_data.get("description", instance.description)
        instance.price = validated_data.get("price", instance.price)
        instance.is_available = validated_data.get("is_available", instance.is_available)
        instance.availability_start = validated_data.get("availability_start", instance.availability_start)
        instance.availability_end = validated_data.get("availability_end", instance.availability_end)
        instance.max_clients_per_slot = validated_data.get("max_clients_per_slot", instance.max_clients_per_slot)
        instance.image = validated_data.get("image", instance.image)
        instance.location = validated_data.get("location", instance.location)
        instance.service_range_mi = validated_data.get("service_range_mi", instance.service_range_mi)
        ...
        for option_data in options_data:
            ...
            if option_id:
                option_instance = ServiceOption.objects.get(id=option_id, service=instance)
