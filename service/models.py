...
class Provider(models.Model):
    ...
    name = models.CharField(max_length=255, help_text="Name of the provider (e.g., business name).")
    description = models.TextField(blank=True, help_text="A description of the provider's business.")
    ...
    contact_email = models.EmailField(blank=True, help_text="Contact email for this provider.")
    phone_number = models.CharField(max_length=15, blank=True, help_text="Contact phone number for the provider.")
...
class Service(models.Model):
    ...
    is_available = models.BooleanField(default=True, help_text="Indicates whether the service is available.")
    availability_start = models.TimeField(null=True, blank=True, help_text="Service availability start time.")
    availability_end = models.TimeField(null=True, blank=True, help_text="Service availability end time.")
    max_clients_per_slot = models.PositiveIntegerField(
        default=1,
        help_text="Maximum number of clients allowed per time slot."
    )
...
class ServiceOption(models.Model):
    ...
    name = models.CharField(max_length=255, help_text="Name of the option (e.g., 'Choose a size').")
    is_required = models.BooleanField(default=False, help_text="Indicates if this option is required.")
...
class ServiceOptionValue(models.Model):
    ...
    """
    option = models.ForeignKey(ServiceOption, on_delete=models.CASCADE, related_name="values")
    name = models.CharField(max_length=255, help_text="Name of the value (e.g., 'Large', 'Medium').")
